...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR">
      ...
      <body className={instrumentSans.className} style={{ backgroundColor: '#0E2A2E', color: '#0E2A2E' }}>
        <div style={{ minHeight: '100vh', display: 'flex' }}>
          <Sidebar brandName={brandName} />
          <div style={{ flex: 1, backgroundColor: '#FAFAF8', display: 'flex', flexDirection: 'column' }}>
            {children}
          </div>
        </div>
      </body>
